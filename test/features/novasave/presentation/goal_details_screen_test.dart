...
void main() {
  ...
  group(
    'GoalDetailsScreen Presentation & Progress (T-NSV-003 / UI-NSV-08)',
    () {
      testWidgets(
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          expect(
            find.text(
              "Requests will be queued securely and processed when you're back online.",
            ),
            findsOneWidget,
          );
        },
